...
///
/// ```rust
/// use rpa_python_stdlib::str::is_lowercase;
///
...
///
/// ```rust
/// use rpa_python_stdlib::str::is_uppercase;
///
...
///
/// ```rust
/// use rpa_python_stdlib::str::is_cased_lowercase;
///
...
///
/// ```rust
/// use rpa_python_stdlib::str::is_cased_uppercase;
///
